...
if [ -z "$1" ]; then
user_input=$(gum input --placeholder "My name is Copilot. What code question would you like to ask?")
fi
...
gum spin --spinner pulse --title "Converging the powers of AI.." --show-output -- xh.exe --ignore-stdin POST $API_ENDPOINT \
